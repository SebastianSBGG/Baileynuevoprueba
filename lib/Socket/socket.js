...
const { LIDMappingStore } = require("../Signal/lid-mapping");
/**
...
const makeSocket = (config) => {
    ...
    // Store de mapeo LID <-> número de teléfono (persistente vía authState.keys).
    // Soluciona comparaciones de admin que fallan en grupos con modo privacidad LID.
    const lidMapping = new LIDMappingStore(keys, logger);
    let lastDateRecv;
    let epoch = 1;
    let keepAliveReq;
    let qrTimer;
