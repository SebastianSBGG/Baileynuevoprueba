...
const { validateKeyDeletions } = require("./pre-key-manager");
/**
...
const addTransactionCapability = (state, logger, { maxCommitRetries, delayBetweenTriesMs }) => {
    ...
    const transactionAwareGet = async (type, ids) => {
        if (isInTransaction()) {
    ...
    return {
        get: transactionAwareGet,
        set: async data => {
            data = await validateKeyDeletions(transactionAwareGet, logger, data);
